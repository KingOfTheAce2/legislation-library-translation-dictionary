...
def main():
    ...
    files = [
        {
            ...
            'book': 'Book 1',
            'output': '../i8n/netherlands/NL-EN-civil-procedure-book1.json'
        },
        {
            'file': 'book 2-3 (sentence).tmx',
            'book': 'Books 2-3',
            'output': '../i8n/netherlands/NL-EN-civil-procedure-book2-3.json'
        },
        {
            'file': 'book 4 (sentence level).tmx',
            'book': 'Book 4',
            'output': '../i8n/netherlands/NL-EN-civil-procedure-book4.json'
        }
    ]
    ...
    if all_translations:
        combined_output = '../i8n/netherlands/NL-EN-civil-procedure-all.json'
