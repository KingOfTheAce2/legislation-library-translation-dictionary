...
def main():
    # Load all books
    book1_file = '../i8n/netherlands/NL-EN-civil-procedure-book1.json'
    book2_3_file = '../i8n/netherlands/NL-EN-civil-procedure-book2-3.json'
    book4_file = '../i8n/netherlands/NL-EN-civil-procedure-book4.json'
    ...
    # Save combined file
    output_file = '../i8n/netherlands/NL-EN-civil-procedure-all.json'
