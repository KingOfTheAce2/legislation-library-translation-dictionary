#!/usr/bin/env python3
"""
Parse Book 2-3 TMX file and convert to JSON format for legislation library
"""
        ...
        for tu in root.findall('.//{*}tu'):
            ...
            if nl_text and en_text:
                translations.append({
                    ...
                    'premium': False,
                    'type': 'legislation',
                    'document': 'Wetboek van Burgerlijke Rechtsvordering - Books 2-3'
                })
...
def main():
    input_file = 'book 2-3 (para).tmx'
    output_file = '../legal-data/netherlands/legislation/civil-procedure/NL-EN-civil-procedure-book2-3.json'
